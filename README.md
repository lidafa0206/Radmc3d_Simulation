...
# How to use our code #
## 0.Example ##
    You can execute the Generate_Sigma.py file.
    The Flux_2855_MJy.txt file represents the radial distribution of observed flux, while the sed.txt file represents the observed Spectral Energy Distribution (SED).
...
## 2.Set parameters ##
    ...
    flaring: flaring index of the disk. Please note that when the value is set to 0.1, it corresponds to a flaring index of 1.1.
...
## 3.Function  ##
    createDSHARPGrain: Generate a customized chemical composition (DHSHARP), a specific number, and a designated size of dust particles.
